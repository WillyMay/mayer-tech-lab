...
function Whatsapp() {
  return (
    <div id="contacto" className="bg-gray-100 dark:bg-gray-800">
      <div className="z-20 w-full px-4 py-12 mx-auto text-center sm:px-6 lg:py-16 lg:px-8">
        <h2 className="text-black dark:text-white sm:text-4xl">
          ...
          <span className="block mt-2 text-2xl font-extrabold leading-8 text-gray-900 dark:text-white sm:text-3xl sm:leading-9">
